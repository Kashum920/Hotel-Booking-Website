...
<body class="bg-light">
   ...
   <?php require "inc/header.php"; ?>
    ...
    <div class="my-5 px-4">
        <h2 class="fa-bold text-center h-font">OUR ROOMS</h2>
        <div class="h-line bg-dark"></div>
    </div>

    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-12 md-lg-0 mb-4">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <label for="f1" class="form-check-label">Faciliti one</label>                
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f2" class="form-check-input shadow-none me-1">
                                    <label for="f2" class="form-check-label">Faciliti two</label>                
                                </div>
                                <div class="mb-2">
                                    <input type="checkbox" id="f3" class="form-check-input shadow-none me-1">
                                    <label for="f3" class="form-check-label">Faciliti three</label>                
                                </div>
                            </div>
                            <div class="border bg-light p-3 rounded mb-3">
                ...
                <div class="card mb-4 border-0 shadow">
                    <div class="row g-0 align-items-center p-3">
                        <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                            <img src="images/rooms/r-1.jpg" class="img-fluid rounded">
                        </div>
                        <div class="col-md-5 px-lg-3 px-md-3 px-0">
                            <h5 class="mb-3">Classic Double Bed</h5>
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="#" class="btn btn-sm w-100 text-white custom-bg shadow-none">More details</a>
                        </div>
                    </div>
                </div>
            </div>                                              
